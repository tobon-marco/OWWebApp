...
var HeroService = (function () {
    ...
    function HeroService(http) {
        ...
        this.heroUrl = 'http://localhost:8085/MyApp/webresources/heroes';
    }
    ...
    //GET HERO BY NAME ==========================================================
    HeroService.prototype.getHero = function (name) {
    ...
    HeroService.prototype.getHeroSkins = function (name) {
    ...
    HeroService.prototype.extractSkins = function (res) {
        var body = res.json();
        console.log("=============");
